...
* **Feature engineering** : raw 데이터들을 변환해서 학습에 사용할 수 있는 좋은 특징들을 얻는 것을 이야기함. 한마디로 데이터 전처리인 것 같음. 굉장히 좋은 [소개글](https://towardsdatascience.com/what-is-feature-engineering-importance-tools-and-techniques-for-machine-learning-2080b0269f10)이 있다.
