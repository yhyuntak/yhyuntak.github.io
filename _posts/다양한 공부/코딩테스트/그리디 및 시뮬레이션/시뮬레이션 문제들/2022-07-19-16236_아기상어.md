---
title: "16236 아기상어"
excerpt : 시뮬레이션 문제가 제일 어렵다. 다시 보자
categories:
  - 코딩테스트
  - 시뮬레이션
toc: true
...
# 1. 문제
문제는 [링크](https://www.acmicpc.net/problem/16236)에 들어가면 있다.
...
이 문제도 결국 혼자 못풀었다.. 시뮬레이션 문제가 제일 나에게 까다롭고 복잡한 것 같다..
시간도 너무 오래걸리고ㅜ 주말마다 복습을 통해 다시 익히도록하자..